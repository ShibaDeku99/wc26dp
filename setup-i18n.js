...
fs.writeFileSync(path.join(__dirname, 'src/lib/i18n.tsx'), i18nContent);

// 2. Create Language Toggle
const toggleContent = `
'use client';
...
`;
fs.writeFileSync(path.join(__dirname, 'src/components/shared/language-toggle.tsx'), toggleContent);
